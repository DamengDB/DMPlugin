...
SOURCES = \
	__init__.py \
	damengplugin.py damengplugin_dialog.py

PLUGINNAME = damengplugin

PY_FILES = \
	__init__.py \
	damengplugin.py damengplugin_dialog.py

UI_FILES = damengplugin_dialog_base.ui
...
QGISDIR=C:\Users\杨\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
